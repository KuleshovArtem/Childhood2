                    ...
                    <div class="col-md-12 col-lg-9 offset-lg-0 col-xl-7 offset-xl-2 ">
                        <div class="header__contacts">
                            <div class="header__contacts-item">
                                ...
                                <a href="mailto:<?php the_field('mail',125);?>" class="header__contacts-mail"><?php the_field('mail',125);?></a>
                            </div>
                            <div class="header__contacts-item">
                                ...
                                <div class="header__contacts-tel">
                                    <a href="tel:<?php the_field('phone_1',125);?>"><?php the_field('phone_1',125);?></a>
                                    <a href="tel:<?php the_field('phone_2',125);?>"><?php the_field('phone_2',125);?></a>
                                </div>
                            </div>
                            <div class="header__contacts-item">
                                <img src="<?php echo bloginfo('template_url');?>/assets/img/icons/svg/pointer.svg" alt="указатель" class="header__contacts-logo">
                                <address><?php the_field('address',125);?></address>
                            </div>
                        </div>
                    </div>
                </div>
